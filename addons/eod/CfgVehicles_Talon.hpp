...
class EWK_Talon_base: Tank_F
{
	...
	class Sounds
	{
		...
		class Engine
		{
			sound[] = {"x\aext\addons\eod\sounds\Talon1.wss",0.3912509,1,240};
		...
		class Engine1_ext
		{
			sound[] = {"x\aext\addons\eod\sounds\Talon1.wss",0.3220185,1,280};
		...
		class Engine2_ext
		{
			sound[] = {"x\aext\addons\eod\sounds\Talon1.wss",0.3589254,1,320};
		...
		class Engine3_ext
		{
			sound[] = {"x\aext\addons\eod\sounds\Talon1.wss",0.3125376,1,360};
		...
		class Engine4_ext
		{
			sound[] = {"x\aext\addons\eod\sounds\Talon1.wss",0.3348932,1,400};
		...
		class Engine5_ext
		{
			sound[] = {"x\aext\addons\eod\sounds\Talon1.wss",0.3382794,1,440};
			frequency = "0.8 + ((rpm/ 2640) factor[(2100/ 2640),(2640/ 2640)])*0.1";
			volume = "engineOn*camPos*((rpm/ 2640) factor[(2150/ 2640),(2500/ 2640)]) * ";
		};
		class IdleThrust
		{
			sound[] = {"x\aext\addons\eod\sounds\Talon1.wss",0.3220185,1,200};
		...
		class EngineThrust
		{
			sound[] = {"x\aext\addons\eod\sounds\Talon1.wss",0.3125376,1,200};
			frequency = "0.8 + ((rpm/ 2640) factor[(700/ 2640),(1100/ 2640)])*0.2";
		...
		{
			sound[] = {"x\aext\addons\eod\sounds\Talon1.wss",0.3282794,1,230};
			frequency = "0.8 + ((rpm/ 2640) factor[(950/ 2640),(1400/ 2640)])*0.2";
		...
		{
			sound[] = {"x\aext\addons\eod\sounds\Talon1.wss",0.3252624,1,290};
			frequency = "0.8 + ((rpm/ 2640) factor[(1200/ 2640),(1700/ 2640)])*0.2";
		...
		{
			sound[] = {"x\aext\addons\eod\sounds\Talon1.wss",0.3282794,1,350};
			frequency = "0.8 + ((rpm/ 2640) factor[(1500/ 2640),(2100/ 2640)])*0.1";
		...
		{
			sound[] = {"x\aext\addons\eod\sounds\Talon1.wss",0.3287211,1,400};
			frequency = "0.8 + ((rpm/ 2640) factor[(1800/ 2640),(2300/ 2640)])*0.1";
		...
		{
			sound[] = {"x\aext\addons\eod\sounds\Talon1.wss",0.328864,1,450};
			frequency = "0.8 + ((rpm/ 2640) factor[(2100/ 2640),(2640/ 2640)])*0.1";
		...
		{
			sound[] = {"x\aext\addons\eod\sounds\Talon1.wss",0.09810717,1};
			frequency = "0.8 + ((rpm/ 2640) factor[(700/ 2640),(1100/ 2640)])*0.2";
		...
		{
			sound[] = {"x\aext\addons\eod\sounds\Talon1.wss",0.04668359,1};
			frequency = "0.8 + ((rpm/ 2640) factor[(950/ 2640),(1400/ 2640)])*0.2";
...
class Talon_Base: EWK_Talon_base
{
	...
	model="x\aext\addons\eod\models\Talon.p3d";
	picture="x\aext\addons\eod\textures\TalonPicture_co.paa";
	Icon= "x\aext\addons\eod\textures\IcoTalon_ca.paa"; /*"x\aext\addons\eod\textures\ui\TalonIcon_co.paa"*/
	cost=250000;
